...
# descriptors. Return the images with the highest similarity.
def compute(img_path, desc_num, method):
    ...
    for descriptor_path in sorted(Path("./images/descriptors").glob("*.npy")):
        # Load descriptor
        distance = 0
...
if __name__ == '__main__':
    compute('images/uploaded.jpg', desc_num=1000, method=0)
